...
<head>        
    ...
    <body>
        ...
        <?php
			...
			pageheader2('Admin Registration');        
        ?>   
        <!-- End: Page Banner -->
        <!-- Start: Cart Section -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="company-detail new-account bg-light">
                                                        ...
                                                        <form class="login" name="registrationForm" method="post" action="includes/adminregister.inc.php" enctype="multipart/form-data" onSubmit="return validateRegistration()">
															<p class="form-row form-row-first input-required" style="margin-bottom: 0px">
																<label>
																	<span class="first-letter">Librarian ID</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="text" id="memid" name="memid" class="input-text" maxlength="10" onFocus= 'document.getElementById("errormessage").style.display ="none"; document.getElementById("successmessage").style.display ="none";' onChange="validatelibid();" required>
