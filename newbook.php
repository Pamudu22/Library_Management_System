                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="company-detail new-account bg-light">
                                                        <div class="new-user-head col-lg-12">
                                                            ...
                                                            <p class="">Please fill this Book Details Form to add this book</p>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <form class="login" name="newbookform" method="post" action="includes/newbook.inc.php" enctype="multipart/form-data" onSubmit="return validatenewbookform()">
															<p class="form-row form-row-first input-required" style="margin-bottom: 0px">
																<label>
																	<span class="first-letter">Book Title</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="text" id="title" name="title" class="input-text" maxlength="200" onFocus= 'document.getElementById("errormessage").style.display ="none"; document.getElementById("successmessage").style.display ="none";'  required>
															...
															<p class="form-row input-required" style="margin-bottom: 0px;">
																<label>
																	<span class="first-letter">ISBN10</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="text" id="isbn10" name="isbn10" class="input-text" onChange="validateisbn10()" maxlength="10" required>
																<p style="margin-top: 0px; margin-bottom: 20px; color: #f56363;" id="isbn10error"></p> 
															</p>
															
															<p class="form-row input-required" style="margin-bottom: 0px;">
																<label>
																	<span class="first-letter">ISBN13</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="text" id="isbn13" name="isbn13" class="input-text" onChange="validateisbn13()" maxlength="13" required>
															...
															<p class="form-row input-required" style="margin-bottom: 0px;">
																...
																<input type="text" id="author" name="author" class="input-text"  maxlength="200" required>					
															</p>
															
															<p class="form-row input-required" style="margin-bottom: 0px;">
																<label>
																	<span class="first-letter">Publisher</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="text" id="publisher" name="publisher" class="input-text"  maxlength="200" required>					
															</p>
															
															<p class="form-row input-required" style="margin-bottom: 0px;">
																<label>
																	<span class="first-letter">Published Year</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="text" id="year" name="year" class="input-text"  maxlength="4" required pattern="[0-9]{4,4}">					
															</p>
															
															<p class="form-row input-required" style="margin-bottom: 0px;">
																<label>
																	<span class="first-letter">Edition</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="number" id="edition" name="edition" class="input-text"  maxlength="3" required>					
															</p>
															...
															<p class="form-row input-required" style="margin-bottom: 0px;">
																...
																<input type="number" id="pages" name="pages" class="input-text"  maxlength="5" required>					
															</p>
															...
															<p class="form-row input-required" style="margin-bottom: 0px;">
																<label>
																	<span class="first-letter">Book Availability</span>  
																	<span class="second-letter">*</span>
																</label>
																<input type="number" id="availability" name="availability" class="input-text"  maxlength="5" required>					
															</p>
                                                            ...
                                                            <p class="form-row input-required" style="">
																...
																<textarea class="form-control" rows="6" maxlength="1000" placeholder="Book Description.............." name="description" id="description"></textarea>			
															...
															<p class="form-row input-required" style="">
																...
																<p class="form-row input-required">  
																<p id="fileName" style="display: inline;"> Choose Book Image: </p>

																<input type="file" id="bookimage" name="bookimage" accept="image/jpeg, image/x-png, image/jpg" class="input-text" style="display: inline;" required>
																</p>	
