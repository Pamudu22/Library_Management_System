                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="company-detail new-account bg-light">
                                                        ...
                                                        <form class="login" name="registrationForm" method="post" action="includes/modifyadminprofile.inc.php" enctype="multipart/form-data">
                                                    ...
                                                    <div class="company-detail new-account bg-light">
                                                        ...
                                                        <form class="login" name="changePwdForm" method="post" action="includes/changepassword.inc.php" enctype="multipart/form-data" onSubmit="return paswordChangeValidate()">
															...
															<p class="form-row input-required">
																...
																<input type="password" id="password" name="password" class="input-text" onFocus= 'document.getElementById("pwderrormessage").style.display ="none"; document.getElementById("pwdsuccessmessage").style.display ="none";' required>
															</p>                                                                                                                                             
															<p class="form-row input-required">
																<label>
